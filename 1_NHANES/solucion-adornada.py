...
print("\n✅ Análisis finalizado.")
print("Sugerencia: prueba reemplazar las variables en los gráficos para explorar nuevas relaciones.")
print("También puedes aplicar filtros para comparar por género, edad o grupo socioeconómico.\n")
